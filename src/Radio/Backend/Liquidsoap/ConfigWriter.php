...
class ConfigWriter implements EventSubscriberInterface
{
    ...
    public function writeHeaderFunctions(WriteLiquidsoapConfiguration $event): void
    {
        if ($event->isForEditing()) {
            $event->prependLines([
                '# ' . __('Welcome to the Radiolize Liquidsoap configuration editor.'),
                '# ' . __('Using this page, you can customize several sections of the Liquidsoap configuration.'),
                '# ' . __('The non-editable sections are automatically generated by Radiolize.'),
            ]);
        } else {
            $event->prependLines([
                '# WARNING! This file is automatically generated by Radiolize.',
    ...
    public function writePlaylistConfiguration(WriteLiquidsoapConfiguration $event): void
    {
        ...
        if (!$station->useManualAutoDJ()) {
            ...
            def azuracast_next_song() =
                uri = {$nextsongCommand}
                log("Radiolize Raw Response: #{uri}")
    ...
    public function writeHarborConfiguration(WriteLiquidsoapConfiguration $event): void
    {
        ...
        def dj_auth(auth_user,auth_pw) =
            ...
            ret = {$authCommand}
            log("Radiolize DJ Auth Response: #{ret}")
        ...
        def live_connected(header) =
            ...
            ret = {$djonCommand}
            log("Radiolize Live Connected Response: #{ret}")
        end
        ...
        def live_disconnected() =
            ...
            ret = {$djoffCommand}
            log("Radiolize Live Disconnected Response: #{ret}")
    ...
    public function writePreBroadcastConfiguration(WriteLiquidsoapConfiguration $event): void
    {
        ...
        $event->appendBlock(<<<EOF
        # Send metadata changes back to Radiolize
        def metadata_updated(m) =
            def f() =
                if (m["song_id"] != "") then
                    ret = {$feedbackCommand}
                    log("Radiolize Feedback Response: #{ret}")
                end
                (-1.)
            end
